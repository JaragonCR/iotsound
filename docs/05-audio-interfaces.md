...
Check out the [customization](03-customization.md) section to learn how to select which audio interface to use. For a detailed and up to date list of what interfaces are supported on each device check out the audio block [documentation](https://github.com/balenablocks/audio#supported-devices) section.
...
- [Supported DACs](#supported-dacs): battle-tested, known to work with IoTSound.
- [Untested DACs](#untested-dacs): DACs whose drivers are included in balenaOS but haven't been tested with IoTSound.
